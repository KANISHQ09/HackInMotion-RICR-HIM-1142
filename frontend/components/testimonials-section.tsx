      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="space-y-6">
          ...
          <div className="relative">
            ...
            <div
              className="flex w-max gap-6 animate-testimonials-ltr hover:[animation-play-state:paused]"
            >
          ...
          <div className="relative">
            ...
            <div
              className="flex w-max gap-6 animate-testimonials-rtl hover:[animation-play-state:paused]"
            >
