...
import (
	...
	"github.com/HackInMotion-RICR-HIM-1142/HackInMotion-RICR-HIM-1142/pkg/locales"
)
...
const (
	...
	defaultConfigPath                  = "/conf/spendly.ini"
...
const (
	...
	defaultDatabaseName            string = "spendly"
	...
	defaultSecretKey                     string = "spendly"
...
func loadServerConfiguration(config *Config, configFile *ini.File, sectionName string) error {
	...
	if err != nil && staticRootPath != "" {
		finalStaticRootPath = staticRootPath
		if !filepath.IsAbs(finalStaticRootPath) {
			finalStaticRootPath = filepath.Join(config.WorkingPath, finalStaticRootPath)
		}
	}
