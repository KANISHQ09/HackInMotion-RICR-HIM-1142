...
const spendlyServerSettingsGlobalVariableName = "SPENDLY_SERVER_SETTINGS"
const spendlyServerSettingsGlobalVariableFullName = "window." + spendlyServerSettingsGlobalVariableName
const spendlyServerSettingsGlobalVariableAlias = "_"
const spendlyServerSettingsJavascriptFileHeader = "(function () {\n" +
	spendlyServerSettingsGlobalVariableFullName +
	"=" + spendlyServerSettingsGlobalVariableFullName + "||{};\n" +
	"const " + spendlyServerSettingsGlobalVariableAlias + "=" + spendlyServerSettingsGlobalVariableFullName + ";\n"
const spendlyServerSettingsJavascriptFileFooter = "})();\n"
...
func (a *ServerSettingsApi) ServerSettingsJavascriptHandler(c *core.WebContext) ([]byte, string, *errs.Error) {
	...
	builder.WriteString(spendlyServerSettingsJavascriptFileHeader)
	...
	builder.WriteString(spendlyServerSettingsJavascriptFileFooter)

	return []byte(builder.String()), "", nil
}

func (a *ServerSettingsApi) appendStringSetting(builder *strings.Builder, key string, value string) {
	builder.WriteString(spendlyServerSettingsGlobalVariableAlias)
	builder.WriteString("[")
