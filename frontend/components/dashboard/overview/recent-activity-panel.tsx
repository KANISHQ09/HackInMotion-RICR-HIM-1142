...
import { recentTransactions, type Transaction } from "@/components/dashboard/overview/data"
...
export const RecentActivityPanel = memo(function RecentActivityPanel({
  ...
  return (
    <section className="overflow-hidden rounded-lg border border-zinc-200/80 bg-white shadow-[0_18px_45px_-32px_rgba(24,24,27,0.35)]" aria-labelledby="recent-activity-title">
      ...
      {error ? (
        <p className="m-4 rounded-lg bg-red-50 px-3 py-2 text-sm font-semibold text-red-700" role="alert">
          {error}
        </p>
      ) : null}
      ...
      <div className="overflow-x-auto">
        <table className="w-full min-w-[650px] border-collapse text-left">
          ...
          <tbody>
            {isLoading ? (
              <tr>
                <td colSpan={4} className="px-6 py-8 text-center text-sm font-medium text-zinc-500">
