...
// defaultTransactionDataJsonImporter defines the structure of spendly default json importer for transaction data
type defaultTransactionDataJsonImporter struct{}

// Initialize an spendly default transaction data json file importer singleton instance
var (
