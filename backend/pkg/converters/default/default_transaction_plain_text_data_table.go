...
// defaultPlainTextDataTable defines the structure of spendly default plain text data table
...
// defaultPlainTextDataRow defines the structure of spendly default plain text data row
type defaultPlainTextDataRow struct {
	allItems []string
}

// defaultPlainTextDataRowIterator defines the structure of spendly default plain text data row iterator
type defaultPlainTextDataRowIterator struct {
	dataTable    *defaultPlainTextDataTable
	currentIndex int
}

// defaultTransactionPlainTextDataTableBuilder defines the structure of spendly default transaction plain text data table builder
