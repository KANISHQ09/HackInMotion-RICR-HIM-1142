...
import (
	...
	"github.com/spendly/spendly/pkg/converters"
...
// ExportDataToSpendlyCSVHandler returns exported data in csv format
func (a *DataManagementsApi) ExportDataToSpendlyCSVHandler(c *core.WebContext) ([]byte, string, *errs.Error) {
	return a.getExportedFileContent(c, "csv")
}

// ExportDataToSpendlyTSVHandler returns exported data in csv format
func (a *DataManagementsApi) ExportDataToSpendlyTSVHandler(c *core.WebContext) ([]byte, string, *errs.Error) {
